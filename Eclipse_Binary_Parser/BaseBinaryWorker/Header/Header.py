...
class Header:
    ...
    def __init__(self, keyword, number_of_objects, datatype):
        self.keyword: str = keyword
        self.number_of_objects: int = number_of_objects
        self.datatype: str = datatype
        self.length: int or None = None
        self.format: str or None = None
        self.start_reading: np.array or None = None
        self.len_reading: np.array or None = None
...
class HeaderConstructor:
    ...
    def from_variable(self, keyword, number_of_objects, datatype):
